...
function EditArticle() {
  ...
  .catch(error=>{
    ...
    <div>{imageartpetitf ?<img src={"/"+imageartpetitf} alt={imageartpetitf} width="530"/>:null}</div> 
   
    <div style={{ marginLeft: '230px' }}>
     <button className="btn btn-success" style={{ fontSize: '20px', padding: '10px 20px' }}>Valider</button>
